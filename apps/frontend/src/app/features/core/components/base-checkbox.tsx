  ...
  return (
    ...
    >
      <input
        {...otherProps}
        className={classNameBuilder(
          'border border-zinc-300 shadow-default relative appearance-none bg-gradient-102deg from-[#B6DCFB] from-10% to-[#E7F3FE] to-90% rounded-sm w-full h-full peer/checkbox',
      ...
      <CheckIcon
        ...
        height={18}
        className={classNameBuilder(
          'absolute -inset-0 text-neutral-darkest hidden pointer-events-none',
